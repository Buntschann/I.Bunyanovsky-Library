...
function setEditorMaterialType(type){
  ...
  if(score){
    $('fMediaType').value='楽譜';
    $('fScoreBarcode').value=$('fScoreBarcode').value||$('barcodeInput').value.trim();
  }else if($('fMediaType').value==='楽譜'){
    $('fMediaType').value='CD';
  }
}
